    ...
    <main>
      ...
      <div class="container">
        <div class="content invite hide">
          ...
          <figure>
           <img
              ...
              srcset="assets/img/denis-kerpaour-750x347_o8dkzk_c_scale,w_350.webp 350w,
              assets/img/denis-kerpaour-750x347_o8dkzk_c_scale,w_650.webp 650w"              
              src="assets/img/denis-kerpaour-750x347_o8dkzk_c_scale,w_650.webp"
              width="650"
              height="347"
              alt="Kerpaour"
              class="info-pic">
        ...
        <div class="content plus hide">
          ...
          <ul>
            <li>Dress code : une touche de rouge</li>
            <li>Des chaussures de marche</li>
            <li>Des talons pour le soir&nbsp;^^</li>
            <li>Prendre des draps ou un sac de couchage pour le gîte</li>
            <li><a href="https://lydia-app.com/pots?id=1881-gite-belle-ile-23-lit-nuit" target="_blank" rel="noopener noreferrer">Payer le gîte :</a> 23€/lit/nuit</li>
          </ul>
        </div>
      </div>
    </main>
